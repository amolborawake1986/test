<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true"
    CodeFile="InputTimesheet.aspx.cs" Inherits="SubmitTimesheet" %>
    ...
    <div style="float: right; width: 82%; background-color: aliceblue; min-height: 420px;
        ...
        <div style="padding-left: 5%;">
            <div align="center" style="padding-top: 2%; height: 48px;">
                <b>
                    <asp:Label ID="lblHeadings" runat="server" Text="Submit Timesheet"></asp:Label></b>
            </div>
            <div class="MiddleContentDiv">
                <asp:Label CssClass="lblWidth" ID="lblSelectDate" runat="server" Text="Select Date*"></asp:Label>
                <asp:TextBox ID="dtpDate" runat="server" AutoPostBack="True" OnTextChanged="dtpDate_TextChanged"></asp:TextBox><img
            ...
            <div class="MiddleContentDiv">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="cmbInHrs"
                    Display="Dynamic" ErrorMessage="Please Select Intime Hrs." ForeColor="Red" InitialValue="- -"
                    ValidationGroup="Group1"></asp:RequiredFieldValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="cmbInMin"
                    Display="Dynamic" ErrorMessage="Select Intime Min." ForeColor="Red" InitialValue="- -"
                    ValidationGroup="Group1"></asp:RequiredFieldValidator>
            </div>
            <div class="MiddleContentDiv">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cmbOutMin"
                    Display="Dynamic" ErrorMessage="Select OutTime Min." ForeColor="Red" InitialValue="- -"
                    ValidationGroup="Group1"></asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <div style="padding-top: 25px; text-align: center;">
            <asp:Button ID="btnShow" runat="server" Text="Show" Enabled="False" OnClick="btnShow_Click" />
            <asp:Button ID="btnSubmitTimesheet" runat="server" Text="Submit Timesheet" OnClick="btnSubmitTimesheet_Click"
                Enabled="False" ValidationGroup="Group1" />
            <asp:Button ID="btnClose" runat="server" Text="Close" />
        </div>
        <div style="overflow: scroll">
            <br />
            <asp:GridView ID="gv_InputTimesheet" HorizontalAlign="Center" runat="server" CellPadding="4"
                ForeColor="#333333" GridLines="Horizontal" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False"
                OnRowDataBound="gv_InputTimesheet_RowDataBound">
