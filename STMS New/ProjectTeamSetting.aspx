<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true"
    CodeFile="ProjectTeamSetting.aspx.cs" Inherits="ProjectTeamSetting" %>
    ...
    <div style="float: right; width: 82%; background-color: aliceblue; min-height: 420px;
        ...
        <div style="padding-left: 5%;">
            <div align="center" style="padding-top: 2%; height: 48px;">
                <b>
                    <asp:Label ID="lblHeadings" runat="server" Text="Project Team Setting"></asp:Label></b>
            </div>
            ...
            <div style="padding-top: 5px; display: inline-flex; width: 100%; padding-left: 25%;">
                <div class="listbox">
                    <div>
                        <asp:Label ID="lblProjectName" runat="server" Text="Project Name*"></asp:Label></div>
                    <div style="overflow: auto">
                        <asp:ListBox ID="lstProjectName" runat="server" Style="height: 170px; width: 100%;"
                            AutoPostBack="True" OnSelectedIndexChanged="lstProjectName_SelectedIndexChanged">
                        </asp:ListBox>
                    </div>
                </div>
                <div class="listbox">
