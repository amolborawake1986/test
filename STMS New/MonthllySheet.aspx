<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true"
    CodeFile="MonthllySheet.aspx.cs" Inherits="CheckInOut" EnableEventValidation="false" %>
    ...
    <div style="float: right; width: 82%; background-color: aliceblue; min-height: 420px;
        ...
        <div style="padding-left: 5%;">
            <div align="center" style="padding-top: 2%; height: 48px;">
                <b>
                    <asp:Label ID="lblHeadings" runat="server" Text="Monthly Timesheet Preview"></asp:Label></b>
            </div>
            ...
            <div style="padding-top: 5px; text-align: center;">
                <asp:Button ID="btnPreviewMonth" runat="server" Text="Preview" OnClick="btnPreviewMonth_Click" /></div>
